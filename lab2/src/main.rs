...
use lab2::declarations::{Play, MIN_ARGS, MAX_ARGS, PROGRAM_NAME_INDEX, CONFIG_FILE_INDEX, 
...
fn main() -> Result<(), u8> {
    ...
    if let Err(_error_code) = lab2::script_gen::script_gen(&config_file_name, &mut play_title, &mut play) {
